...
Codex should first propose and justify the architecture before writing code.
...
Do not assume this is final. Codex should evaluate options and explain tradeoffs.

## Required Planning Output Before Coding

Before writing code, Codex must produce:
