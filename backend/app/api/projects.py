...
def export_manuscript(project_id: int, db: Session = Depends(get_db)) -> dict[str, str]:
    ...
    lines += [
        "## References",
        "",
        "*References are generated from the NeuroForge Citation Studio. Open the Methods Studio for each dataset to export a formatted bibliography.*",
        "",
    ]
