...
from app.reporting import data_table, document_shell, footer, info_box, key_value_table, metadata_grid
...
def _write_html_report(path: Path, metadata: dict[str, Any], rows: list[dict[str, Any]]) -> None:
    ...
    resamp_note = (
        info_box("Resampling", "Atlas was resampled to image space using nearest-neighbour interpolation to match spatial geometry.")
