...
from app.reporting import document_shell, figure_block, footer, info_box, key_value_table
...
def _write_html_report(
    ...
    visible_metadata = ((k, v) for k, v in metadata.items() if k not in {"roi_labels", "source_bold_path", "source_mask_path", "source_confounds_path"})
